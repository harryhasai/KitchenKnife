package com.harry.kitchenknife.function.renting_pay;
 ...
 * 租赁支付页面
 */
public class RentingPayActivity extends BaseActivity {
    ...
    protected int setupView() {
        return R.layout.activity_renting_pay;
    }
    ...
    protected void initView() {
        ...
        commodityTypeRentalPrice = getIntent().getDoubleExtra("commodityTypeSellingPrice", 0);
        commodityTypeRent = getIntent().getDoubleExtra("commodityTypeRent", 0);
    ...
    private void initViewParams() {
        ...
        tvDeposit.setText("租赁金额: ¥" + Integer.valueOf(number) * commodityTypeRentalPrice + "(每日)");
        tvDeposit.setText("押金: ¥" + Integer.valueOf(number) * commodityTypeRent);
        tvPhone.setText("预留手机号: " + phone);
    ...
    private void getAliPay() {
        ...
        params.put("bindMobilePhoneNumber", phone);
